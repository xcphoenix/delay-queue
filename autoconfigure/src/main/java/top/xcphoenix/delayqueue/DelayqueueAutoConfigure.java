...
public class DelayqueueAutoConfigure {
    ...
    @Bean("delayqueueConnectionFactory")
    ...
    @Bean("delayqueueRedisTemplate")
    public StringRedisTemplate redisTemplate(@Qualifier("delayqueueConnectionFactory") RedisConnectionFactory redisConnectionFactory) {
    ...
    public ServiceRegister serviceRegister(GroupMonitor groupMonitor,
                                           ...
                                           @Qualifier("delayqueueRedisTemplate") StringRedisTemplate redisTemplate) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public DelayQueueService delayQueueService(GroupMonitor groupMonitor, @Qualifier("delayqueueRedisTemplate") StringRedisTemplate redisTemplate) {
